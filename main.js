...
fetch('https://covid-193.p.rapidapi.com/statistics', options).then((data)=>{
    return data.json();
}).then((objectData)=>{
...
fetch('https://covid-193.p.rapidapi.com/statistics?country='+country, options).then((res) => res.json())
.then((res) => {
    //console.log(res)
...
fetch('https://covid-193.p.rapidapi.com/history?country=all&day='+date, options).then((res) => res.json())
    .then((res) => {
        console.log(res)
